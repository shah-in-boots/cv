...
bib |>
	...
	arrange(issued) |>
	select(-c(volume, issued, abstract, URL, DOI, ISSN, page, keyword))
```
...
bib |>
	filter(type == "book") |>
	arrange(issued) |>
	select(-c(volume, issued, abstract, DOI, ISSN, page, keyword, `container-title`))
```
...
bib |>
	...
	arrange(issued) |>
	select(-c(issued, ISSN, publisher, page, keyword))
```
